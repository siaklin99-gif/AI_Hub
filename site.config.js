  ...
  pages: [
    {
      ...
      nav: 'Start',
      track: null,
      pagerTitle: 'Start — the five tracks',
    ...
    },
    {
      ...
      footNote: 'The term "jagged technological frontier" is from Dell\'Acqua et al., Harvard Business School / BCG working paper, 2023 — the idea is theirs, the words on this page are ours.',
    },
    {
      file: 'trust.html',
      nav: 'Trust',
    ...
    },
    {
      ...
      cardBlurb: 'The mental model that works, the five parts of a good request, ten patterns worth stealing, the beginner mistakes that waste the most time, and what never to paste in.',
    ...
    },
    {
      ...
      cardBlurb: 'A 30-day plan at 20 minutes a day. How to find AI-shaped work in your job. What this does to careers, honestly. And what it really takes to start an AI company.',
      pagerTitle: 'Go Further — study, work, and building something',
      title: 'Go Further — study, work, careers, and starting something',
      description: 'A 30-day plan at 20 minutes a day, how to find AI-shaped work in your job, what this honestly does to careers, and what it really takes to start an AI company.',
  ...
  externalTracks: [
    {
      ...
      cardBlurb: 'Start here if the words themselves are the problem. A separate one-page guide that peels AI apart in ten layers, in plain language, with a quiz at the end. Opens on another site.',
