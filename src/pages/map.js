...
<section id="good">
  <div class="wrap">
    ...
    <p class="lead">
      ...
      these ten with different names on them. Open any you haven't tried.
    </p>
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>It cannot tell its own remembering from its own inventing. Both come out sounding the same.</td>
  ...
  <div class="wrap">
    ...
    <div class="card">
      <ul class="checklist">
        ...
        <li><input type="checkbox" id="au9"><label for="au9">Rewrite an angry message — to a supplier, a landlord, a customer — so it stays firm but lands well.</label></li>
        ...
        <li><input type="checkbox" id="au16"><label for="au16">Give it my messy list of anything — staff availability, the stock order, the packing list — and ask for it back as a sorted table.</label></li>
      </ul>
      <div class="progress">
