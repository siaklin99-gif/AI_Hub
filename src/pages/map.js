...
<section id="good">
  <div class="wrap">
    ...
    <p class="lead">
      A list of <em>shapes of work</em>, not features — most useful requests are one of
      these ten in different clothes. Open any you haven't tried.
    </p>
...
<section id="jagged">
  <div class="wrap">
    ...
    <figure class="fig">
      <svg viewBox="0 0 380 185" role="img" aria-label="Chart: expected ability is a smooth rising line; actual AI ability is a jagged line with sharp peaks and valleys across tasks">
        <line x1="34" y1="150" x2="366" y2="150" stroke="var(--border-med)" stroke-width="1.2"/>
        <line x1="34" y1="150" x2="34" y2="18" stroke="var(--border-med)" stroke-width="1.2"/>

        <text x="24" y="88" text-anchor="middle" font-size="11" fill="var(--text-ter)" transform="rotate(-90 24 88)">ability</text>
        <path d="M40 128 L360 44" stroke="var(--text-ter)" stroke-width="1.5" stroke-dasharray="5 4" fill="none"/>
        <text x="258" y="42" font-size="11" fill="var(--text-ter)">what people expect</text>
        <path d="M40 118 L70 38 L100 96 L130 30 L160 122 L190 54 L220 138 L250 34 L280 108 L310 46 L340 96 L360 60"
              stroke="var(--green)" stroke-width="2.2" fill="none" stroke-linejoin="round"/>
        <circle cx="130" cy="30" r="4.5" fill="var(--green)"/>
        <text x="130" y="20" text-anchor="middle" font-size="11" fill="var(--green)">expert-level</text>
        <circle cx="220" cy="138" r="4.5" fill="var(--red)"/>
        <line x1="220" y1="143" x2="220" y2="160" stroke="var(--red)" stroke-width="1" stroke-dasharray="2 2"/>
        <text x="220" y="174" text-anchor="middle" font-size="11" fill="var(--red)">basic slip</text>
      </svg>
      <figcaption>The jagged frontier: across different tasks, brilliance and blunders sit side by side — and neither predicts the next.</figcaption>
    </figure>
