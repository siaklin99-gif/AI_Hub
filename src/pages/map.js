  ...
  <div class="wrap">
    ...
    <figure class="fig">
      <svg viewBox="0 0 380 185" role="img" aria-label="Chart: expected ability is a smooth rising line; actual AI ability is a jagged line with sharp peaks and valleys across tasks">
        ...
        <text x="24" y="88" text-anchor="middle" font-size="12" fill="var(--text-ter)" transform="rotate(-90 24 88)">ability</text>
        <path d="M40 128 L360 44" stroke="var(--text-ter)" stroke-width="1.5" stroke-dasharray="5 4" fill="none"/>
        <text x="258" y="42" font-size="12" fill="var(--text-ter)">what people expect</text>
        ...
        <text x="130" y="20" text-anchor="middle" font-size="12" fill="var(--green)">expert-level</text>
        ...
        <text x="220" y="174" text-anchor="middle" font-size="12" fill="var(--red)">basic slip</text>
      </svg>
