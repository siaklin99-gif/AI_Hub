...
<section id="categories">
  <div class="wrap">
    <p class="slabel">The six shapes</p>
  ...
  <div class="wrap">
    ...
    <ol class="steps">
      <li><h3>Is the material genuinely confidential?</h3>
        ...
        before pasting. Ask this before the other three: the rest are reversible, and this one is not.</p></li>
...
<section id="checkyourself">
  <div class="wrap">
    ...
    <ul class="clean">
      ...
      <li><strong>Re-run your five prompts.</strong> Not part of the five minutes — give this one twenty, once or twice a year. It answers the only question you actually had.</li>
