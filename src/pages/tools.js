...
<section id="flow">
  <div class="wrap">
    ...
    <figure class="fig">
      <svg viewBox="0 0 380 300" role="img" aria-label="Flowchart: four yes-or-no questions route you to search-connected, reasoning, agent, or an approved private tool; otherwise general chat">
        <rect x="14" y="10" width="212" height="34" rx="8" fill="var(--surface)" stroke="var(--border-med)" stroke-width="1.2"/>
        <text x="120" y="31" text-anchor="middle" font-size="12" fill="var(--text)">About something recent?</text>
        <rect x="252" y="10" width="116" height="34" rx="8" fill="var(--blue-bg)"/>
        <text x="310" y="31" text-anchor="middle" font-size="12" fill="var(--blue)">search-connected</text>
        ...
        <text x="120" y="97" text-anchor="middle" font-size="12" fill="var(--text)">Steps must be right in order?</text>
        <rect x="252" y="76" width="116" height="34" rx="8" fill="var(--blue-bg)"/>
        <text x="310" y="97" text-anchor="middle" font-size="12" fill="var(--blue)">reasoning mode</text>
        ...
        <text x="120" y="163" text-anchor="middle" font-size="12" fill="var(--text)">Needs doing, not just writing?</text>
        <rect x="252" y="142" width="116" height="34" rx="8" fill="var(--blue-bg)"/>
        <text x="310" y="163" text-anchor="middle" font-size="12" fill="var(--blue)">agent / coding tool</text>
        ...
        <rect x="14" y="208" width="212" height="34" rx="8" fill="var(--surface)" stroke="var(--amber)" stroke-width="1.3"/>
        <text x="120" y="229" text-anchor="middle" font-size="12" fill="var(--text)">Genuinely confidential?</text>
        <rect x="252" y="208" width="116" height="34" rx="8" fill="var(--amber-bg)"/>
        <text x="310" y="229" text-anchor="middle" font-size="12" fill="var(--amber)">approved tool only</text>
      ...
      <figcaption>The last question overrides the other three.</figcaption>
    </figure>
